            ...
            <div class="card mini-stats-wid">
                <a href="{{ route('todo.index') }}">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium">Pending Task</p>
                                <h4 class="mb-0">{{ $todo }}</h4>
                            </div>

                            <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                <span class="avatar-title rounded-circle bg-primary">
                                    <i class="fa fa-tasks font-size-24" aria-hidden="true"></i>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-centered table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <div>
                                            <img src="{{ asset('dash_board') }}/assets/images/product/img-7.png"
                                                alt="" class="avatar-sm">
                                        </div>
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div>
                                            <img src="{{ asset('dash_board') }}/assets/images/product/img-4.png"
                                                alt="" class="avatar-sm">
                                        </div>
                                    </th>
                                    <td>
